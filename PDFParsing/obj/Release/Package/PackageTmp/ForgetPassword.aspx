<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgetPassword.aspx.cs" Inherits="PDFParsing.ForgetPassword" %>

<!DOCTYPE html>

<html>	
<head>
<title>MudraCube: Forgot Password</title>
...
<div class="login-form">
    ...
    <div style="padding:20px;">
                        Do you know your password, <a href="/default.aspx">Click here</a>
                    </div>
	<div class="signin">
		<asp:Button ID="btnLogin2" runat="server" Text="Send Email" OnClick="btnLogin2_Click1" ClientIDMode="Static" CssClass="btn btn-lg btn-success btn-block" />
	</div>
</div>
            </div>
