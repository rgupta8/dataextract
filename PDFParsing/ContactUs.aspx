<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="PDFParsing.ContactUs" %>

<!DOCTYPE html>

<html>	
<head>
<title>MudraCube: Contact Us</title>
...
<div class="login-form">
    ...
    <asp:Label ID="lblMsg" runat="server"></asp:Label>
                    ...
                    <asp:TextBox ID="txtMessage" ClientIDMode="Static" TextMode="MultiLine" Rows="6" CssClass="text" runat="server" placeholder="Message"></asp:TextBox>
	<div class="signin">
		<asp:Button ID="btnSend" runat="server" Text="Send" OnClick="btnSend_Click" ClientIDMode="Static" CssClass="btn btn-lg btn-success btn-block" />
	</div>
</div>
            </div>
